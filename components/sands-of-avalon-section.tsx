...
const worlds = [
  ...
  },
  {
    ...
    screenshots: [
      { src: "/new medieval/HighresScreenshot00021 (1).webp", alt: "Avalon — forest path, medieval world" },
      { src: "/new medieval/HighresScreenshot00017 (1).webp", alt: "Medieval landscape" },
      { src: "/new medieval/HighresScreenshot00023 (1).webp", alt: "Medieval environment" },
      { src: "/new medieval/HighresScreenshot00035 (1).webp", alt: "Medieval vista" },
    ],
    tag: "Medieval Era",
  },
]
