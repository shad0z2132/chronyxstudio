...
const worlds = [
  ...
  },
  {
    ...
    screenshots: [
      { src: "/new medieval/HighresScreenshot00002 (1).webp", alt: "Avalon — medieval world" },
      { src: "/new medieval/HighresScreenshot00007 (1).webp", alt: "Medieval castle environment" },
      { src: "/new medieval/HighresScreenshot00013 (1).webp", alt: "Forest exploration" },
      { src: "/new medieval/HighresScreenshot00021 (1).webp", alt: "Medieval combat" },
    ],
    tag: "Medieval Era",
  },
]
